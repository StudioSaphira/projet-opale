  ...
  async execute(interaction) {
    ...
    try {
      ...
      db.prepare(`
        ...
        VALUES (?, ?)
        ON CONFLICT(guild_id) DO UPDATE SET channel_counter_boost_id = excluded.channel_counter_boost_id
      ...
      console.error('[TOPAZE] Erreur DB – /config-counter-boost :', error);
      return interaction.reply({
